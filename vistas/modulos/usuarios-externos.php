        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="box-header with-border">
                    ...
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAgregarUsuarioExterno">

                        <i class='fa fa-user text-uppercase'></i> Nuevo Usuario Externo
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-bordered dt-responsive nowrap tablaUsuariosExternos" width="100%">
...
======================================-->
<div id="modalAgregarUsuarioExterno" class="modal fade" role="dialog">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary guardarUsuarioExterno">Guardar Usuario</button>
